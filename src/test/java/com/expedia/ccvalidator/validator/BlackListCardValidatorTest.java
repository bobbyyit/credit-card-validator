...
public class BlackListCardValidatorTest {
    ...
    public void returnsErrorForBlacklistedCard() {
        Optional<String> result = blackListedCardValidator.validate(BasicValidatorTest.aCreditCart("4711111111111111", "02-2014"));
    ...
    public void returnsOkForNonBlacklistedCard() {
        Optional<String> result = blackListedCardValidator.validate(BasicValidatorTest.aCreditCart("5145454545452323", "02-2014"));
